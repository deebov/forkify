...
// Function to clear the recipe element
export const clearRecipe = () => {
  DOM.recipe.innerHTML = '';
};

// Function to update the servings and the counts
export const updataServings = recipe => {
  // Update servings
  document.querySelector('.recipe__info-data--people').textContent =
    recipe.servings;

  // Update ingredients
  const countElem = document.querySelectorAll('.recipe__count');
